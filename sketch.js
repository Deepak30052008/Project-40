...
var ground, invisibleGround, groundImage,running;
...
function preload(){
  ...
  running=loadImage("trex1.png","trex3.png","trex4.png");
...
function setup() {
  ...
  trex = createSprite(50,windowHeight-45,20,50);
  trex.addAnimation("running", trex_running);
  trex.addAnimation("collided" ,trex_collided);
  trex.scale = 0.8 ;
  
  ground = createSprite(200,windowHeight-35,400,20);
...
function draw() {
  ...
  //displaying score
  textSize(20);
  text("Score: "+ score, windowWidth-150,windowHeight-500);
  

  camera.position.y=trex.y-150
